...
import { Decimal } from "@prisma/client/runtime/library"  // ✅ Import correcto
...
export async function POST(request: NextRequest) {
  try {
    ...
    // ✅ Calcular monto por participante usando Decimal correctamente
    const montoPorPeriodo = new Decimal(montoTotal).div(participantes.length)
