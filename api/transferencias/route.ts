...
// ============================================================
// ✅ POST - Crear nueva transferencia asociada a un préstamo
// ============================================================
...
// ============================================================
// ✅ GET - Obtener transferencias de un préstamo específico
// ============================================================
export async function GET(request: NextRequest) {
  try {
    ...
    // ✅ Se tipa el parámetro 'transferencia' para evitar el error
    return NextResponse.json(
